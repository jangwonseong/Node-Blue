...
public class ModbusToMqttNode extends InOutNode {
     ...
     */
    public ModbusToMqttNode(int slaveId, String modbusHost, int modbusPort, String mqttBroker) throws Exception {
        super();
    ...
    //     ModbusToMqttNode node =
    //             new ModbusToMqttNode(1, "192.168.70.203", 502, "tcp://192.168.71.213:1883");
